# fromscratchtoml
https://markoxor.github.io/fromscratchtoml/

[![Build Status](https://travis-ci.org/markoxor/fromscratchtoml.svg?branch=master)](https://travis-ci.org/markoxor/fromscratchtoml)
[![Coverage Status](https://coveralls.io/repos/github/markoxor/fromscratchtoml/badge.svg?branch=master)](https://coveralls.io/github/markoxor/fromscratchtoml?branch=master)
[![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
[![Gitter chat](https://badges.gitter.im/gitterHQ/gitter.png)](https://gitter.im/jellAIfish/from-scratch-to-ml)
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fmarkoxor%2Ffromscratchtoml.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2Fmarkoxor%2Ffromscratchtoml?ref=badge_shield)
...
## Goals
 ...
 - To write [intuitive blogs as python notebooks](https://markoxor.github.io/fromscratchtoml/showroom/) so as to juxtapose theory and code. Explaining the fundamentals of the algorithm from the very basics.  
...
from source -  
    ...
    git clone https://github.com/markoxor/fromscratchtoml.git
    pip install -r requirements.txt  
    python setup.py install

## Tutorials and support
* Well documented API usage is available at [pydoc](https://www.pydoc.io/pypi/fromscratchtoml-0.0.1/)
* For discussion and support visit - [the gitter channel](https://gitter.im/markoxor/from-scratch-to-ml)
* Development discussions and bugs reports can be tracked on [issue tracker](https://github.com/markoxor/fromscratchtoml/issues).
...
## License
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fmarkoxor%2Ffromscratchtoml.svg?type=large)](https://app.fossa.io/projects/git%2Bgithub.com%2Fmarkoxor%2Ffromscratchtoml?ref=badge_large)
